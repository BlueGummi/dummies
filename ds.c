...
int main(int argc, char *argv[]) {
    ...
    Allocator *mylloc = allocator_init();
    int *p = allocator_arenalloc(mylloc, sizeof(int));
    *p = 42;
    int *d = allocator_alloc(mylloc, sizeof(int));
    *d = 33;
    allocator_info(mylloc);
    allocator_destroy(&mylloc);
